...
public class MovableObject implements MovableInterface {
    ...
    public MovableObject(JPanel mainPanel, String filename, float x, float y, int width,
            int height) {
        direction = 0; // Location.NORTH;
        hidden = false;
        speed = 3;
    ...
    public MovableObject(JPanel mainPanel, String filename, Image image, int x, int y, int width,
            int height) {
        direction = 0; // Location.NORTH;
        hidden = false;
        speed = 3;
    ...
    public MovableObject(JPanel mainPanel, String filename, Image image, float x, float y,
    ...
    public float isHittingLeftSideOfOtherObjectByAmount(MovableObject other, int closeness,
            int width) {
        Rectangle rect1 = new Rectangle((int) (getX() + getWidth() - width + closeness),
                (int) getY(), width, (int) getHeight());
        Rectangle rect2 = new Rectangle((int) other.getX(), (int) other.getY(), width,
                (int) other.getHeight());
    ...
    public float isHittingRightSideOfOtherObjectByAmount(MovableObject other, int closeness,
            int width) {
        Rectangle rect1 = new Rectangle((int) getX() - closeness, (int) getY(), width,
                (int) getHeight());
        Rectangle rect2 = new Rectangle((int) (other.getX() + other.getWidth() - width),
                (int) other.getY(), width, (int) other.getHeight());
    ...
    public float isHittingTopSideOfOtherObjectByAmount(MovableObject other, int closeness,
            int height) {
        Rectangle rect1 = new Rectangle((int) getX(),
                (int) (getY() + getHeight() - height + closeness), getWidth(), height);
        Rectangle rect2 = new Rectangle((int) other.getX(), (int) other.getY(),
                (int) other.getWidth(), height);
    ...
    public float isHittingBottomSideOfOtherObjectByAmount(MovableObject other, int closeness,
            int height) {
        Rectangle rect1 = new Rectangle((int) getX(), (int) (getY() - closeness), getWidth(),
                height);
        Rectangle rect2 = new Rectangle((int) other.getX(),
                (int) (other.getY() + other.getHeight() - height), (int) other.getWidth(), height);
